...
// Float16 platform guard: Float16 is unavailable on macOS x86_64; the conformance cannot compile where the type itself does not exist. A universal macOS build (`-destination 'generic/platform=macOS'`) compiles the x86_64 slice and fails without this guard.
